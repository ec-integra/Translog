...
public class RecIMU extends Record {
    ...
    public void printCols(lineType lineT) {
        try {
            ...
            String slongitudeDegrees = Double.toString(longitudeDegrees);
            slongitudeDegrees = slongitudeDegrees.replace(".", "");

            String slatitudeDegrees = Double.toString(latitudeDegrees);
            slatitudeDegrees = slatitudeDegrees.replace(".", "");
